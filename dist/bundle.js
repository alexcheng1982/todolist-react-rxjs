...
/***/ function(module, exports, __webpack_require__) {
	...
	var todos_impl_1 = __webpack_require__(160);
	var TodoList_1 = __webpack_require__(162);
	var todosService = new todos_impl_1.TodosServiceImpl();
	ReactDOM.render(React.createElement(TodoList_1.default, {"todoList": todosService.list()}), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var todo_impl_1 = __webpack_require__(161);
	var list = new todo_impl_1.TodoListImpl();
	var todo1 = new todo_impl_1.TodoImpl();
	todo1.id = '1';
	todo1.description = 'Todo -1';
	list.addTodo(todo1);
	var todo2 = new todo_impl_1.TodoImpl();
	todo2.id = '2';
	todo2.description = 'Todo -2';
	todo2.markAsCompleted();
	list.addTodo(todo2);
	var TodosServiceImpl = (function () {
	    function TodosServiceImpl() {
	    }
	    TodosServiceImpl.prototype.list = function () {
	        return list;
	    };
	    return TodosServiceImpl;
	})();
	exports.TodosServiceImpl = TodosServiceImpl;
...
/***/ function(module, exports) {
	...
	var TodoImpl = (function () {
	    function TodoImpl() {
	        this.completed = false;
	        this.lastUpdatedAt = new Date().getTime();
	    }
	    TodoImpl.prototype.isCompleted = function () {
	        return this.completed;
	    };
	    TodoImpl.prototype.markAsCompleted = function () {
	        this.completed = true;
	        this.updated();
	    };
	    TodoImpl.prototype.markAsUncompleted = function () {
	        this.completed = false;
	        this.updated();
	    };
	    TodoImpl.prototype.getLastUpdatedAt = function () {
	        return this.lastUpdatedAt;
	    };
	    TodoImpl.prototype.updated = function () {
	        this.lastUpdatedAt = new Date().getTime();
	    };
	    return TodoImpl;
	})();
	exports.TodoImpl = TodoImpl;
	var TodoListImpl = (function () {
	    function TodoListImpl() {
	        this.todos = [];
	    }
	    TodoListImpl.prototype.getTodos = function () {
	        return this.todos;
	    };
	    TodoListImpl.prototype.addTodo = function (todo) {
	        this.todos.push(todo);
	        return this;
	    };
	    TodoListImpl.prototype.removeTodo = function (todoId) {
	        return this;
	    };
	    return TodoListImpl;
	})();
	exports.TodoListImpl = TodoListImpl;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var TodoItem_1 = __webpack_require__(163);
	var TodoListComponent = (function (_super) {
	    ...
	    TodoListComponent.prototype.render = function () {
	        return (React.createElement("ul", null, this.props.todoList.getTodos().map(function (todo) { return React.createElement(TodoItem_1.default, {"key": todo.id, "todo": todo}); })));
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoItemComponent = (function (_super) {
	    ...
	    TodoItemComponent.prototype.render = function () {
	        ...
	        var _a = this.props.todo, id = _a.id, description = _a.description;
	        return (React.createElement("li", null, description));
	    };
